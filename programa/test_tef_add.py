...
class One(Screen):
    def __init__(self, **kwargs):
        ...
        lab_name = Label(text = "Введіть імя",
                         size_hint = (0.2,0.05), pos_hint={"y":0.40, "x":0.1})
        lab_age = Label(text = "Введіть вік",
                        size_hint = (0.2,0.1), pos_hint={"y":0.30, "x":0.1})
        

        name_input = TextInput(multiline = False,
                               size_hint = (0.2,0.05), pos_hint={"y":0.40, "x":0.3})
        name_input2 = TextInput(multiline = False,
                                    size_hint = (0.2,0.05), pos_hint={"y":0.32, "x":0.3})
        line.add_widget(lab_name)
        line.add_widget(lab_age)
        line.add_widget(name_input)
        line.add_widget(name_input2)
